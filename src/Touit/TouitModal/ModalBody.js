        ...
        <div className="modal-body">
            <form>
                <div className="row g-3 col-12">
                    ...
                    <Input inputType={"text"} inputClassList={'form-control'} inputId={`comment-pseudo-${props.id}`} maxLenght={16} required={true} labelContent={'Pseudo'} placeholder={'pseudo'} method={props.getNameInputValue}/>
                    <Input inputType={"text"} inputClassList={'form-control'} inputId={`commentaire-${props.id}`} maxLenght={200} required={true} placeholder={'commentaire'} method={props.getCommentInputValue}/>
                </div>
            </form>
        </div>
    )
